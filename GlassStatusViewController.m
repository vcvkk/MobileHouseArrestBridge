...
static const CGFloat kBasePillWidth = 115.0;
...
- (void)setupTelegramLiquidGlassNavigationBar {
    ...
    // === 4. Tab 1: Dashboard Button & Centered Label ===
    ...
    // === 5. Tab 2: Console Button & Centered Label ===
...
- (CGRect)indicatorFrameForProgress:(CGFloat)progress {
    ...
    CGFloat endX = (kBarWidth * 0.5) + kPadding - 1.0;
